defmodule Orderer do
  ...
  ## Examples
    ...
    [[%Entry{item: %Item{name: "Борщ", price: %Money{amount: 12300, currency: :USD}},quantity: 6}]]
  ...
  ## Examples
    ...
    ...> [%Entry{item: %Item{name: "avocado", price: %Money{amount: 10000, currency: :USD}}, quantity: 1}, %Entry{item: %Item{name: "bacon", price: %Money{amount: 20000, currency: :USD}}, quantity: 2}],
    ...> [%Entry{item: %Item{name: "cheddar", price: %Money{amount: 30000, currency: :USD}}, quantity: 3}]],
    ...> %Item{name: "doritos", price: %Money{amount: 40000, currency: :USD}}, 4)
    [[%Entry{item: %Item{name: "avocado", price: %Money{amount: 10000, currency: :USD}}, quantity: 1},
      %Entry{item: %Item{name: "bacon", price: %Money{amount: 20000, currency: :USD}}, quantity: 2},
      %Entry{item: %Item{name: "doritos", price: %Money{amount: 40000, currency: :USD}}, quantity: 4}],
     [%Entry{item: %Item{name: "cheddar", price: %Money{amount: 30000, currency: :USD}}, quantity: 3},
      %Entry{item: %Item{name: "doritos", price: %Money{amount: 40000, currency: :USD}}, quantity: 4}]]
    ...
    ...> [%Entry{item: %Item{name: "avocado", price: %Money{amount: 10000, currency: :USD}}, quantity: 1}, %Entry{item: %Item{name: "bacon", price: %Money{amount: 20000, currency: :USD}}, quantity: 2}],
    ...> [%Entry{item: %Item{name: "cheddar", price: %Money{amount: 30000, currency: :USD}}, quantity: 3}]],
    ...> %Item{name: "doritos", price: %Money{amount: 40000, currency: :USD}}, 0)
    [[%Entry{item: %Item{name: "avocado", price: %Money{amount: 10000, currency: :USD}}, quantity: 1},
      %Entry{item: %Item{name: "bacon", price: %Money{amount: 20000, currency: :USD}}, quantity: 2}],
     [%Entry{item: %Item{name: "cheddar", price: %Money{amount: 30000, currency: :USD}}, quantity: 3}]]
  ...
  Return a list of orders with the given total.  Expects menu to be sorted with most expensive items first.
    ...
    [[%Entry{item: %Item{name: "Chips", price: %Money{amount: 10000, currency: :USD}}, quantity: 1},
      %Entry{item: %Item{name: "Pepsi", price: %Money{amount: 16500, currency: :USD}}, quantity: 1},
      %Entry{item: %Item{name: "Cheezborger", price: %Money{amount: 31500, currency: :USD}}, quantity: 1}]]
  """
